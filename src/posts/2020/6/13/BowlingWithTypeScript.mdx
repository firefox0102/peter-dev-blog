...
The funny thing is, even as a self professed JavaScript Hipster I was a little hesitant to try TypeScript. As an observer, you would obviously think that is nuts right? You would tell someone to use the bumpers! Maybe it fear of slowing down, it's fear of the unknown, or just laziness, but I honestly should've been using this a lot earlier in my career and feel pretty dumb for not doing so.
