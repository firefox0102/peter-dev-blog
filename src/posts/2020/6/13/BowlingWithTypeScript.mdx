...
Imagine you've just got a job as a professional bowler. You've only got a 4 year bachelors of science in Bowling Science, but you've never actually bowled in a production environment before.
...
I might be pretty decent at bowling, but I'm not sure if **EVERY** time I could break 150. My degree in bowling Science is only theoretical, half the time I tend to throw a gutter ball!
...
- Third party libraries ship type definitions, helping you figure out and use them a lot faster
...
The funny thing is, most JavaScript Hipsters (myself included) are a little hesitant to try TypeScript. As an observer, you would obviously think that is nuts right? You would tell someone to use the bumpers! Maybe it fear of slowing down, it's fear of the unknown, or just laziness, but I honestly should've been using this a lot earlier in my career and feel pretty dumb for not doing so.

#### That's it for now!

TypeScript is like bowling with bumpers up. It is like a safety net that can prevent you from making stupid mistakes, allowing you to focus more on other things and not on constantly fishing your ball out of the gutter when it gets stuck. TypeScript will probably save you a lot of headaches that stock JavaScript can't help you with, and I highly recommend checking it out in your projects if you like shipping quality code.

I implore you, PLEASE give it a try! I promise you it will help you focus on hitting the pins and remove the distraction avoiding gutter balls 🎳
