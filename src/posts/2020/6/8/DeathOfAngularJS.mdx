...
- Pages vs Components: This was really the first time anyone had built complex Frontend applications, so a lot of the time we were just building pages that matched how we thought of things in stock web development.
Components were a thing in AngularJS, but React really emphasised it as a best practice.
